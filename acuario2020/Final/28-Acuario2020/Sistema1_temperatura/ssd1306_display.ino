...
void display_ssd1306(){
  ...
  if (flip==0) {
      display.print("Temperature :");display.println(temperatureC);
      display.print("mV_TDS : ");display.println(mV_TDS);
      display.print("TDS :");display.println(tdsValue);
  ...
  if (flip==3) {
        display.setTextSize(2);
       display.print("tdsValue :");display.println(tdsValue);
  
  }
  if (flip==4) {
        display.setTextSize(1);
        display.print("Calent :");display.println(estados[4]);
        display.print("Vent :");display.println(estados[5]);
