...
void sendTime() {
  ...
  json += "\"Fecha\":\"" + Fecha + "\",";
  json += "\"tmt4.power\":\"" + String(tmt4.Power) + "\"}";
...
void sendMesures() {
  ...
  String json = "{\"tmt4_power\":\"" + String(tmt4.Power) + "\",";
...
void sendTabMesures2() {
   //Serial.println("inicio sendTabMesures2");
      ...
      doc["Active_Power"]           = String(Active_Power) + " W";
      doc["tmt4_Total"]           =  String(tmt4.Total) + " kWh";
      doc["tmt4_Today"]           =  String(tmt4.Today) + " kWh";
      doc["tmt4_Yesterday"]       =  String(tmt4.Yesterday) + " kWh";
      doc["tmt4_Power"]           =  String(tmt4.Power) + " W";
      doc["tmt4_ApparentPower"]   =  String(tmt4.ApparentPower) + " VA";
      doc["tmt4_ReactivePower"]   =  String(tmt4.ReactivePower) + " VAr";
      doc["tmt4_Factor"]          =  String(tmt4.Factor) + "";
      doc["tmt4_Voltage"]         =  String(tmt4.Voltage) + " V";
      doc["tmt4_Current"]         =  String(tmt4.Current) + " A";
...
void sendTabMesures3() {
  ...
  server.send(200, "application/json", json3);
  DPRINTLN("Datos de medidas enviados");
  DPRINTLN(json);
}
void horasolar(){
