...
void sendDataTimers(){
 ...
 void sendDataConf(){
    ...
    int mm;
      ...
      doc["sunrise"] =      salida;
      doc["sunset"] =       puesta;
      doc["G_max"] =       conf.G_max;
      doc["G_min"] =       conf.G_min;
      doc["G_mode"] =      conf.G_mode;
 ...
 */
    ...
    conf.G_max = server.arg("G_max").toFloat();
    conf.G_min = server.arg("G_min").toFloat();
    conf.G_mode = server.arg("G_mode").toInt();
...
void saveG(){
    DPRINTLN("Recibido comando saveG");
    conf.G_max = server.arg("G_max").toFloat();
    conf.G_min = server.arg("G_min").toFloat();
    saveConfig();
    String success = "1";
  String json = "{\"conf.G_max\":\"" + String(conf.G_max) + "\",";
  json += "\"conseguido\":\"" + String(success) + "\",";
  json += "\"success\":\"" + String(success) + "\"}";
  server.send(200, "application/json", json);
 }
...
void sendMesures() {
  String json = "{\"G\":\"" + String(G) + "\",";
  json += "\"mV_G\":\"" + String(mV_G) + "\",";
  json += "\"G2\":\"" + String(G2) + "\",";
  json += "\"mV_G2\":\"" + String(mV_G2) + "\",";
  json += "\"G3\":\"" + String(G3) + "\",";
  json += "\"mV_G3\":\"" + String(mV_G3) + "\",";
  json += "\"G4\":\"" + String(G4) + "\",";
  json += "\"mV_G4\":\"" + String(mV_G4) + "\"}";
...
void sendTabMesures() {
  double temp = G_ant;
  String json = "[";
  json += "{\"medida\":\"G\",\"valor\":\"" + String(G) + "\",\"unidad\":\" \",\"precedente\":\"" + String(temp) + "\"},";
  temp = mV_G_ant;          
  json += "{\"medida\":\"mV_G\",\"valor\":\"" + String(mV_G) + "\",\"unidad\":\"mV\",\"precedente\":\"" + String(temp) + "\"},";

  temp = G2_ant;          
  json += "{\"medida\":\"G2\",\"valor\":\"" + String(G2) + "\",\"unidad\":\"Wm-2\",\"precedente\":\"" + String(temp) + "\"},";
  temp = mV_G2_ant;          
  json += "{\"medida\":\"mV_G2\",\"valor\":\"" + String(mV_G2) + "\",\"unidad\":\"mV\",\"precedente\":\"" + String(temp) + "\"},";

   temp = G3_ant;          
  json += "{\"medida\":\"G3\",\"valor\":\"" + String(G3) + "\",\"unidad\":\"Wm-2\",\"precedente\":\"" + String(temp) + "\"},";
  temp = mV_G3_ant;          
  json += "{\"medida\":\"mV_G3\",\"valor\":\"" + String(mV_G3) + "\",\"unidad\":\"mV\",\"precedente\":\"" + String(temp) + "\"},";

   temp = G4_ant;          
  json += "{\"medida\":\"G4\",\"valor\":\"" + String(G4) + "\",\"unidad\":\"Wm-2\",\"precedente\":\"" + String(temp) + "\"},";
  temp = mV_G4_ant;     
  json += "{\"medida\":\"mV_G4\",\"valor\":\"" + String(mV_G4) + "\",\"unidad\":\"mV\",\"precedente\":\"" + String(temp) + "\"}";
  json += "]";
  server.send(200, "application/json", json);
